...
namespace CAR_RENTAL_APPLICATION.Controllers
{
    public class PaymentMethodsController : Controller
    {
        ...
        public PaymentMethodsController(CarsContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("PaymentMethodId,PName")] PaymentMethod paymentMethod)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PaymentMethodId,PName")] PaymentMethod paymentMethod)
        {
