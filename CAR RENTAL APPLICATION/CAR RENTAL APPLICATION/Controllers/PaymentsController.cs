...
namespace CAR_RENTAL_APPLICATION.Controllers
{
    public class PaymentsController : Controller
    {
        ...
        public PaymentsController(CarsContext context)
        {
            _context = context;
        }
        ...
        {
            var carsContext = _context.Payments.Include(p => p.PaymentMethod);
        ...
        public async Task<IActionResult> Create([Bind("PaymentId,PaymentMethodId,Amount,TimeStamp")] Payment payment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PaymentId,PaymentMethodId,Amount,TimeStamp")] Payment payment)
        {
